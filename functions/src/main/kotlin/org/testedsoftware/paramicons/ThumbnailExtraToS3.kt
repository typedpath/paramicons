...
fun thumbnailExtraToS3(bucketName: String,  svg: String, urlRoot: String, openGraphTagging: OpenGraphTagging, rawQueryString: String) : String {
    println("calling thumbnail")
    val thumbnail = thumbnailExtra(svg = svg, urlRoot=urlRoot, rawQueryString=rawQueryString,
        openGraphTagging = openGraphTagging)
